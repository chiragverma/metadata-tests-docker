...
SVC_NAME="actions.runner.chiragverma-metadata-tests-docker.Chirags-MacBook-Air"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (chiragverma-metadata-tests-docker.Chirags-MacBook-Air)"
